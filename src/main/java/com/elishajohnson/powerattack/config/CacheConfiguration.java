package com.elishajohnson.powerattack.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.elishajohnson.powerattack.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.elishajohnson.powerattack.repository.UserRepository.USERS_BY_EMAIL_CACHE);
